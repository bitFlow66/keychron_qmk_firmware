...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
 [MAC_BASE] = LAYOUT_iso_83(
    ...
    [MAC_FN] = LAYOUT_iso_83(
        ...
        RGB_TOG,  S(KC_NUHS),   ALGR(KC_Q),     S(KC_4),        KC_GRV,         S(KC_0),  _______,  _______,  ALGR(KC_RBRC),    _______,  _______,  _______,  _______,  _______,
        ...
        _______,  _______,  _______,  KC_EQL,   ALGR(KC_NUBS),  ALGR(KC_MINS),  S(KC_6),  _______,  _______,  _______,          _______,  _______,            _______,  _______,
